    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm">
            Monitor and manage all posted rides
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4 gap-2">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-10 h-10 rounded-full bg-slate-700 flex-shrink-0 flex items-center justify-center text-blue-400 font-bold shadow-sm">
                    {ride.poster_name.charAt(0).toUpperCase()}
                  </div>
                  <div className="min-w-0">
                    <h3
                      className="text-white font-semibold text-sm truncate"
                      title={ride.poster_name}
                    >
                      {ride.poster_name}
                    </h3>
                    <span
                      className={`inline-block text-[10px] uppercase font-bold px-2 py-0.5 mt-0.5 rounded-full ${
                ...
                <div
                  className={`flex-shrink-0 px-2 py-1 rounded-lg text-xs font-medium uppercase ${
                    ride.status === "active"
              ...
              <div className="flex items-center flex-wrap gap-2 mb-4">
                ...
                <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-blue-500/10 border border-blue-500/20">
                  ...
                  <span className="text-blue-400 text-xs font-semibold">
                    {ride.available_seats ?? ride.number_of_seats} /{" "}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-white mb-1">
                      {selectedRide.poster_name}
                    </h2>
                    <div className="flex items-center gap-3 text-sm text-slate-400">
                      <span>
                        {selectedRide.ride_type === "driver"
                          ? "Driver"
                          : "Passenger"}
                      </span>
                    </div>
                  ...
                  selectedRide.vehicle_info && (
                    <div className="bg-amber-500/10 rounded-2xl p-5 border border-amber-500/20">
                      ...
                      <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                        <div>
                          <span className="text-xs text-amber-500/70 block">
                            Brand & Model
                          </span>
                          <p className="text-amber-200 font-medium">
                            {selectedRide.vehicle_info.brand}{" "}
                            {selectedRide.vehicle_info.model}
                          </p>
                        </div>
                        <div>
                          <span className="text-xs text-amber-500/70 block">
                          ...
                          <p className="text-amber-200 font-medium">
                            {selectedRide.vehicle_info.year}
                          </p>
                        </div>
                        <div>
                          <span className="text-xs text-amber-500/70 block">
                          ...
                          <p className="text-amber-200 font-medium">
                            {selectedRide.vehicle_info.color}
                          </p>
                        </div>
                        <div>
                          <span className="text-xs text-amber-500/70 block">
